...
│   │   │   │   │   │   │   ├── 00000_radar.pcd - 00250_radar.pcd # the 4D Radar point clouds data from timestamp 0 to 250
│   │   │   │   │   │   │   ├── 00000.yaml - 00250.yaml # corresponding metadata for each timestamp
│   │   │   │   │   │   │   ├── 00000_camera0.png - 00250_camera0.png # left camera images
│   │   │   │   │   │   │   ├── 00000_camera1.png - 00250_camera1.png # front camera images
│   │   │   │   │   │   │   ├── 00000_camera2.png - 00250_camera2.png # right camera images
│   │   │   │   │   │   ├── 142 # Vehicle Side
│   │   │   │   ├── validate
│   │   │   │   ├── test
...
conda install python=3.8 pytorch=1.12.0 torchvision=0.13.0 torchaudio=0.12.0 cudatoolkit=11.6 -c pytorch -c conda-forge
