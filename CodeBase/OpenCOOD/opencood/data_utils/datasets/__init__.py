from opencood.data_utils.datasets.unified_fusion_dataset import getUnifiedFusionDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert fusion_name in ['unified']
    assert dataset_name in ['opv2v', 'v2xset']
