        ...
        def get_item_single_car(self, selected_cav_base):
            ...
            if sensor_type == "camera":
                ...
                for idx, img in enumerate(camera_data_list):
                    ...
                    # change H W in data_aug_conf -- add in 2024.07.25 by chenying
                    if params["RSU"]:
                        eval(f"self.data_aug_conf_{modality_name}")['H'] = 864
                        eval(f"self.data_aug_conf_{modality_name}")['W'] = 1536
                    else:
                        eval(f"self.data_aug_conf_{modality_name}")['H'] = 864
                        eval(f"self.data_aug_conf_{modality_name}")['W'] = 1536
