...
if __name__ == "__main__":
    src_root = "datasets/v2x-radar-v2xset-coop-radar"
    dest_root = "datasets/v2x-radar-v2xset-coop-radar-data"
    print("hello world ...")
        ...
        for seq in os.listdir(os.path.join(src_root, split)):     
            for agent in ["-1", "142"]:
                ...
                for filename in tqdm(os.listdir(src_path)):
                    ...
                    shutil.copy2(os.path.join(src_path, "{:05d}_camera0.jpg".format(frame_id)), os.path.join(dest_path, "{:05d}_camera0.jpg".format(frame_id)))
                    shutil.copy2(os.path.join(src_path, "{:05d}_camera1.jpg".format(frame_id)), os.path.join(dest_path, "{:05d}_camera1.jpg".format(frame_id)))
                    shutil.copy2(os.path.join(src_path, "{:05d}_camera2.jpg".format(frame_id)), os.path.join(dest_path, "{:05d}_camera2.jpg".format(frame_id)))
