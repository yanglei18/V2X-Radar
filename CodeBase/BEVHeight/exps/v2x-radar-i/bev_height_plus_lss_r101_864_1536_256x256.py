...
class BEVHeightPlusLightningModel(LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = NuscMVDetDataset(
            ...
            info_path=os.path.join(data_root, 'v2x_radar_i_12hz_infos_train.pkl'),
            is_train=True,
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/bev_height_plus_lss_r101_864_1536_256x256/checkpoints', filename='{epoch}', every_n_epochs=8, save_last=True, save_top_k=-1)
