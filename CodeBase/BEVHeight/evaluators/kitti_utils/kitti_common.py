...
category_map = {"Car": "Car", "Van": "Car", "Truck": "Car", "Bus": "Car", "Pedestrian": "Pedestrian", "Cyclist": "Cyclist"}
...
def get_label_anno(label_path):
    ...
    annotations['name'] = np.array([category_map[x] if x in category_map.keys() else x for x in annotations['name']])
